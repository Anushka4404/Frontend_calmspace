// CalmSpace Chatbot - Website Assistant Bot
class CalmSpaceChatbot {
    constructor() {
        this.isOpen = false;
        this.messages = [];
        this.init();
    ...
    addWelcomeMessage() {
        setTimeout(() => {
            this.addBotMessage("👋 Hi! I'm your CalmSpace assistant. I can help you navigate our website, find resources, or answer questions about mental wellness. How can I assist you today?", [
        ...
        if (quickActions.length > 0) {
            quickActionsHtml = `
                <div class="quick-actions">
                    ${quickActions.map(action => `<button class="quick-action" onclick="calmspaceChatbot.handleQuickAction('${action}')">${action}</button>`).join('')}
                </div>
            `;
        }
    ...
    processMessage(message) {
        ...
        // Getting started
            ...
            response = "🚀 Welcome to CalmSpace! Here's how to get started:<br><br>1. Create an account or log in<br>2. Complete your profile<br>3. Start tracking your mood<br>4. Explore our resources<br><br>Ready to begin your wellness journey?";
        ...
        // Contact and support
            ...
            response = "📞 I'm here to help! For additional support, you can:<br><br>• Email: support@calmspace.edu<br>• Helpline: 1800-123-4567<br>• Or continue chatting with me<br><br>What specific help do you need?";
            quickActions = ["Technical issue", "Mental health emergency", "General question"];
        }
        
        // About CalmSpace
        else if (lowerMessage.includes('about') || lowerMessage.includes('calmspace') || lowerMessage.includes('what is')) {
            response = "🧠 CalmSpace is a comprehensive mental health platform for students. We provide mood tracking, counseling resources, peer support, and educational content to support your mental wellness journey.";
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('chatbot-toggle')) {
        window.calmspaceChatbot = new CalmSpaceChatbot();
    }
});

// Handle quick actions for navigation
window.handleChatbotNavigation = function(page) {
    window.calmspaceChatbot.navigateToPage(page);
};